...
import { imageviewerportraitheightmargin } from "../../constants/starterkit";
  ...
  try {
    ...
    return (
      <SafeAreaView style={styles.container}>
        <HeaderBar title="Download Flyer" />
    ...
    console.error(error);
    return (
      <CenteredView title="Download Flyer" style={styles.container}>
        <EmptyPlaceholder title="Flyer Starter Kit" text={error.toString()} onOpenExternalLink={() => Linking.openURL(webfotowatermark)} />
      </CenteredView>
    );
  }
};
