...
import WatermarkModel from "../../../components/media/VWatermarkModel";
...
import { sharingOptionsPDF, watermarkStyle } from "../../../components/media/constants";
...
const MultipleImageView = (props) => {
  ...
  try {
    ...
    return (
      <CenteredView title={title ? title : "Download File"} style={styles.container}>
