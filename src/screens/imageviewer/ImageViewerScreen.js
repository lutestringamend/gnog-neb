...
import { multiplephotoshtml, multiplephotosimgtagcustomwidthheight,
  pdfpageheight,
  pdfpagewidth, } from "../../constants/imageviewer";
...
const ImageViewer = (props) => {
  ...
  return (
    <CenteredView title={title ? title : "Foto Daclen"} style={styles.container}>
      {id === undefined ||
      id === null ||
      watermarkData === undefined ||
      watermarkData === null ||
